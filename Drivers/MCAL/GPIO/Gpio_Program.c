...
/* Fun. Argument3: Copy_u8Mode { OUTPUT , INPUT , AF , ANALOG }                                 */
...
/* Fun. Argument6: enum AFR { Peripheral }                                                      */
/* Fun. Return : void                                                                           */
/************************************************************************************************/
void GPIO_voidPinInit (u8 Copy_u8PortID , u8 Copy_u8PinID , u8 Copy_u8Mode, u8 Copy_u8Type ,u8 Copy_u8Speed ,u8 Copy_u8AFNumber)
{
	...
	else 
	{
		...
		if( Copy_u8Mode == AF )
		{
			GPIO_voidPinInit_AF(Copy_u8PortID,Copy_u8PinID,Copy_u8AFNumber);
		}
	}
}

/************************************************************************************************/
/* Function Name : GPIO_voidPinInit_AF                                                          */
/* Description : Inilization of Alternative Pin                                                 */
/* Fun. Argument1: Copy_u8PortID { GPIOA,GPIOB,GPIOC }                                          */
/* Fun. Argument2: Copy_u8PinID { PIN0 -> PIN15 }                                               */
/* Fun. Argument3: enum AFR { Peripheral }                                                      */
/* Fun. Return : void                                                                           */
/************************************************************************************************/
void GPIO_voidPinInit_AF(u8 Copy_u8PortID , u8 Copy_u8PinID , AFR Peripheral)
{
	if(Copy_u8PortID > GPIOC || Copy_u8PinID > PIN15 || Peripheral > PIN15)
	{
		/* Do Nothing*/
	}
	else 
	{
		if(Peripheral < 8)
		{
			...
			{
			case GPIOA:
				GPIOA_REG->AFRL &= (0b0000 << (Copy_u8PinID *4));
				GPIOA_REG->AFRL |= (Peripheral << (Copy_u8PinID *4));
				break;
			case GPIOB:
				GPIOB_REG->AFRL &= (0b0000 << (Copy_u8PinID *4));
				GPIOB_REG->AFRL |= (Peripheral << (Copy_u8PinID *4));
				break;
			case GPIOC:
				GPIOC_REG->AFRL &= (0b0000 << (Copy_u8PinID *4));
				GPIOC_REG->AFRL |= (Peripheral << (Copy_u8PinID *4));
				break;
			default:
				break;
			}
		}
		else if(Peripheral >= 8)
		{
			switch(Copy_u8PortID)
			{
			case GPIOA:
				GPIOA_REG->AFRH &= (0b0000 << ((Copy_u8PinID-8) *4));
				GPIOA_REG->AFRH |= (Peripheral << ((Copy_u8PinID-8) *4));
				break;
			case GPIOB:
				GPIOB_REG->AFRH &= (0b0000 << ((Copy_u8PinID-8) *4));
				GPIOB_REG->AFRH |= (Peripheral << ((Copy_u8PinID-8) *4));
				break;
			case GPIOC:
				GPIOC_REG->AFRH &= (0b0000 << ((Copy_u8PinID-8) *4));
				GPIOC_REG->AFRH |= (Peripheral << ((Copy_u8PinID-8) *4));
				break;
			default:
				break;
			}
...
/* Fun. Return : void                                                                           */
/************************************************************************************************/
void GPIO_voidPortInit(u8 Copy_u8PortID ,u8 Copy_u8Mode ,u8 Copy_u8Type ,u8 Copy_u8Speed,u8 Copy_u8AFNumber)
{
	...
	else
	{
		...
		{
			GPIO_voidPinInit( Copy_u8PortID,  Pin,  Copy_u8Mode,  Copy_u8Type, Copy_u8Speed, Copy_u8AFNumber);
		}
	}
}
/************************************************************************************************/
